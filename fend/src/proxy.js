...
function contentSecurityPolicy(nonce) {
  ...
  return [
    "default-src 'self'",
    `script-src 'self' 'nonce-${nonce}' 'strict-dynamic'${development ? " 'unsafe-eval'" : ""} https://cdn.tiny.cloud`,
    ...
    "object-src 'none'",
    "base-uri 'self'",
    "frame-ancestors 'self' https://nickwebproject.com https://www.nickwebproject.com",
    "form-action 'self'",
