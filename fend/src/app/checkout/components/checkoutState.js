...
export function shippingLabel(shipping) {
  if (shipping && typeof shipping === "object") {
    return String(shipping.label || shipping.logisticName || shipping.method || "ارسال");
  }
  if (!shipping) return "ارسال";
  return shipping === "express" ? "ارسال سریع" : shipping === "standard" ? "ارسال عادی" : String(shipping);
}
...
export function shippingWindow(shipping) {
  if (shipping && typeof shipping === "object") return String(shipping.window || "زمان تحویل در حال محاسبه است");
  return shipping === "express" ? "۳ تا ۷ روز کاری" : shipping === "standard" ? "۷ تا ۱۵ روز کاری" : "زمان تحویل در حال محاسبه است";
}
