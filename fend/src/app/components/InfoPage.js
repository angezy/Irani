      ...
      <Container maxWidth="md">
        <Card sx={{ borderRadius: 4, border: "1px solid var(--color-border)", boxShadow: "0 18px 50px rgba(43,43,43,0.08)" }}>
          <CardContent sx={{ p: { xs: 3, md: 5 } }}>
            ...
            {actions && <Stack direction={{ xs: "column", sm: "row" }} spacing={1.5} sx={{ mt: 5 }}><Button href="/checkout" variant="contained" sx={{ borderRadius: 999 }}>رفتن به پرداخت</Button><Button href="/contact" variant="outlined" sx={{ borderRadius: 999 }}>ارتباط با پشتیبانی</Button></Stack>}
          </CardContent>
        </Card>
      </Container>
    </Box>
