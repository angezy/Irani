      ...
      <Slider {...settings} style={{ marginLeft: "-12px", marginRight: "-12px" }}>
        {loading
          ...
          : products.map((product) => {
              ...
              const title = product.name || product.title || 'محصول بدون عنوان';
                  ...
                  >
                    ...
                    <CardContent sx={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
                      <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
                        ...
                        <Chip label={formatMoney(price)} color="primary" size="small" sx={{ fontWeight: 600 }} />
                      </Stack>
                      <Typography
                        variant="body2"
                        sx={{
                      ...
                      >
                        {desc || "توضیحی برای این محصول ثبت نشده است."}
                      </Typography>
                      <Box sx={{ mt: "auto" }}>
